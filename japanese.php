...
<head>
    ...
    <title>Alashibarecipes - Japanese Recipes</title>
    <link href="stylesindex.css" rel="stylesheet" type="text/css">
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom Styles -->
    <link href="stylesjapanese.css" rel="stylesheet" type="text/css">
...
<main>
    <div class="container-fluid p-0">
        ...
        <div class="recipe-header w-100 position-relative">
            <img src="images/sushi.jpg" alt="Japanese Cuisine Image" class="img-fluid w-100" style="height: 400px; object-fit: cover;">
    ...
    <div class="container mt-5">
        <div class="recipe-content mt-4">
            <p>Explore the exquisite world of Japanese cuisine. From sushi to ramen, discover the delicate flavors and artful presentation of Japan's culinary traditions.</p>

            <!-- Fetch and display Japanese recipes from the database -->
            <div class="row">
                <?php
                // Modified query to fetch Japanese cuisine recipes with their specific meal type
                $stmt = $pdo->query('
    SELECT 
        CASE
    ...
    WHERE Cuisine.CuisineName = "Japanese"
