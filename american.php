...
<head>
    ...
    <title>Alashibarecipes - American Recipes</title>
    <link href="stylesindex.css" rel="stylesheet" type="text/css">
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom Styles -->
    <link href="stylesamerican.css" rel="stylesheet" type="text/css">
...
<main>
    ...
    <img src="images/pork bbq burger.avif" alt="American Cuisine Image" class="img-fluid w-100">
    <div class="header-overlay">
        <h1>Delicious American Recipes</h1>
    </div>
</div>

<div class="container">
<div class="recipe-content">
            <p>Discover the diverse flavors of American cuisine. From hearty burgers to comforting apple pies, explore the classic and contemporary dishes that define American cooking.</p>

            <!-- Display American recipes from the database -->
            <div class="row">
                <?php
                // Modified query to fetch American cuisine recipes with their specific meal type
                $stmt = $pdo->query('
    SELECT 
        CASE
    ...
    WHERE Cuisine.CuisineName = "American"
