...
<head>
    ...
    <title>Alashibarecipes - Lunch Recipes</title>
    <link href="stylesindex.css" rel="stylesheet" type="text/css">
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom Styles -->
    <link href="styleslunch.css" rel="stylesheet" type="text/css">
...
<div class="container-fluid p-0">
        ...
        <div class="recipe-header w-100 position-relative">
            <img src="images/chicken rice.jpg" alt="Lunch Image" class="img-fluid w-100" style="height: 400px; object-fit: cover;">
    ...
    <div class="container mt-5">
        <div class="recipe-content mt-4">
            <p>Discover our delicious lunch recipes. From quick and easy sandwiches to hearty salads, find the perfect midday meal to fuel your afternoon.</p>

            <!-- Fetch and display approved lunch recipes -->
            <div class="row">
                <?php
                // Fetch approved lunch recipes and images from the database
                $stmt = $pdo->query('
                    SELECT Lunch.LunchID, Lunch.LunchName, Lunch.LunchDescription, Images.ImagePath 
                    FROM Lunch 
                    JOIN Images ON Lunch.ImageID = Images.ImageID
                    WHERE Lunch.Status = "approved"
                ');
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a href="recipe.php?id=<?php echo $row['LunchID']; ?>&type=lunch">
                                <img src="<?php echo htmlspecialchars($row['ImagePath']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($row['LunchName']); ?>">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="recipe.php?id=<?php echo $row['LunchID']; ?>&type=lunch">
                                        <?php echo htmlspecialchars($row['LunchName']); ?>
                                    </a>
                                </h5>
                                <p class="card-text"><?php echo htmlspecialchars($row['LunchDescription']); ?></p>
                            </div>
                        </div>
                    </div>
                    <?php
