...
<head>
    ...
    <title>Alashibarecipes - French Recipes</title>
    <link href="stylesindex.css" rel="stylesheet" type="text/css">
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom Styles -->
    <link href="stylesfrench.css" rel="stylesheet" type="text/css">
...
<main>
    <div class="container-fluid p-0">
        ...
        <div class="recipe-header w-100 position-relative">
            <img src="images/croissant.jpg" alt="French Cuisine Image" class="img-fluid w-100" style="height: 400px; object-fit: cover;">
    ...
    <div class="container mt-5">
        <div class="recipe-content mt-4">
            <p>Indulge in the exquisite flavors of French cuisine. From delicate pastries to rich sauces, explore the culinary artistry that has made French cooking world-renowned.</p>

            <!-- Fetch and display French recipes from the database -->
            <div class="row">
                <?php
                // Modified query to fetch French cuisine recipes with their specific meal type
                $stmt = $pdo->query('
    SELECT 
        CASE
    ...
    WHERE Cuisine.CuisineName = "French"
