...
<head>
    ...
    <title>Alashibarecipes - Chinese Recipes</title>
    <link href="stylesindex.css" rel="stylesheet" type="text/css">
    <!-- Bootstrap CSS -->
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom Styles -->
    <link href="styleschinese.css" rel="stylesheet" type="text/css">
...
<main>
    <div class="container-fluid p-0">
        ...
        <div class="recipe-header w-100 position-relative">
            <img src="images/beijing smoke duck.jpg" alt="Chinese Cuisine Image" class="img-fluid w-100" style="height: 400px; object-fit: cover;">
    ...
    <div class="container mt-5">
        <div class="recipe-content mt-4">
            <p>Discover the authentic taste of Chinese cuisine. From dim sum to stir-fries, explore the rich and diverse flavors of China.</p>

            <!-- Fetch and display Chinese recipes from the database -->
            <div class="row">
                <?php
                // Modified query to fetch Chinese cuisine recipes with their specific meal type
                $stmt = $pdo->query('
    SELECT 
        CASE
    ...
    WHERE Cuisine.CuisineName = "Chinese"
